...
Рациональные значения толщин исследуемых обшивок, полученные в данном проектировочном исследования, оказались несколько больше, чем приведенные в \ref{eq:pants_n4}. Таким образом, условия по устойчивости этих стенок оказались выполненными. 